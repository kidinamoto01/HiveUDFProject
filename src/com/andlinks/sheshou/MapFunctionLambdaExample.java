...
public class MapFunctionLambdaExample {
    public static void main(final String[] args) throws Exception {
        ...
        final KStream<byte[], String> textLines = builder.stream(byteArraySerde, stringSerde, "streams-file-input");
        ...
        originalAndUppercased.to(stringSerde, stringSerde, "streams-wordcount-output");
